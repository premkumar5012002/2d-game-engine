...
class Registry {
    private:
        ...
        // Vector of component signatures per entity, saying which components are turned "on" for an entity
...
void Registry::AddSystem(TArgs&& ...args) {
    TSystem* newSysten(new TSystem(std::forward<TArgs>(args)...));
    systems.insert(std::make_pair(std::type_index(typeid(TSystem)), newSysten));
}
